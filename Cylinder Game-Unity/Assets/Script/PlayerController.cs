...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        if (levellcontrol.Current == null || !levellcontrol.Current.gameActive)
        {
            return;
        }
    ...
    if (_spawningBridge)
   {
      ...
      if(_creatingBridgeTimer < 0)
            {
                ...
                if (_finished)
                {
                    ...
                    {
                        _scoreTimer = 0.3f;
                        levellcontrol.Current.ChangeScore(1);
                    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        }else if (other.tag == "StopSpawnBridge")
        {
            ...
            if (_finished)
            {
                levellcontrol.Current.FinishGame();
            }
        ...
        else if(other.tag == "coin")
        {
            ...
            other.tag = "Untagged";
            levellcontrol.Current.ChangeScore(10);
            Destroy(other.gameObject);
        }
    }
    ...
    {
        if (levellcontrol.Current.gameActive)
        {
    ...
    public void IncrementCylinderVolume(float value)
    {
        ...
        {
            cyclinders[cyclinders.Count - 1].IncrementCylinderVolume(value);
        }
    }
       ...
       public void die(){
        ...
        levellcontrol.Current.GameOver();
    }

    public void CreateCylinder(float value)
    {
        RidingCyclinder createdCyclinder = Instantiate(ridingCylinderPrefab, transform).GetComponent<RidingCyclinder>();
        cyclinders.Add(createdCyclinder);
        createdCyclinder.IncrementCylinderVolume(value);
    }

    public void DestroyCylinder(RidingCyclinder cylinder)
    {
        cyclinders.Remove(cylinder);
